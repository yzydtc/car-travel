...
public class HBaseUtil {
     ...
     * @throws IOException
     */
    private static void initConnection() throws IOException, URISyntaxException {
...
//            conf.set("hbase.zookeeper.quorum", "192.168.52.100,192.168.52.110,192.168.52.120");
     ...
     * @throws IOException
     */
    public static Connection getConnection() throws IOException, URISyntaxException {
        if (connection == null || connection.isClosed()) {
            initConnection();
        }
...
//        String tn_htab_gps = tablen.getNameAsString();
//        TableName [] tnlist = admin.listTableNames();
//        for (TableName tn : tnlist){
//            if(tn_htab_gps == tn.getNameAsString())
//                return true;
//        }
//        return false;
