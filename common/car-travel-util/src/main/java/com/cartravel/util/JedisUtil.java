...
//        System.out.println("ConfigConstants.JEDIS_HOST:"+ConfigConstants.JEDIS_HOST);
//        System.out.println("ConfigConstants.JEDIS_PORT:"+ConfigConstants.JEDIS_PORT);
        System.out.println("ConfigConstants.JEDIS_PASS:"+ConfigConstants.JEDIS_PASS);
        System.out.println(ConfigUtil.getConfig(ConfigConstants.JEDIS_HOST));
        System.out.println(ConfigUtil.getConfig(ConfigConstants.JEDIS_PORT));
