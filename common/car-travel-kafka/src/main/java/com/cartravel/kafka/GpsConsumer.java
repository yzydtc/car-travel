...
//        props.put("bootstrap.servers", "192.168.21.178:9092");
        ...
        if (records.count() > 0) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                if (value.contains(",")) {
                    ...
                    byte[] orderBytes = jedis.hget(Constants.ORDER_START_END_TIME.getBytes()
                            , orderId.getBytes());
                    ...
                    if (null != tmpOrderObj) {
                        ...
                        jedis.hset(Constants.ORDER_START_END_TIME.getBytes(), orderId.getBytes(),
    ...
    public static void main(String[] args) {
        ...
        //消费组id
        String groupId = "cheng_du_gps_consumer_04";
